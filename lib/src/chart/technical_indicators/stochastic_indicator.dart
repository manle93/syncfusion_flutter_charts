...
// ignore:unused_element
  ...
  List<CartesianChartPoint<dynamic>> _calculatePeriod(
      ...
      TechnicalIndicatorsRenderer technicalIndicatorsRenderer) {
    final List<num> lowValue = List<num>.filled(data.length, null);
    final List<num> highValue = List<num>.filled(data.length, null);
    final List<num> closeValue = List<num>.filled(data.length, null);
