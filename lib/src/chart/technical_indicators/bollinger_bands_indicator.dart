...
class BollingerBandIndicator<T, D> extends TechnicalIndicators<T, D> {
  ...
  void _initDataSource(BollingerBandIndicator<dynamic, dynamic> indicator,
    ...
    if (validData.isNotEmpty &&
      ...
      final List<num> smaPoints = List<num>.filled(limit, null);
      final List<num> deviations = List<num>.filled(limit, null);
      final List<_BollingerData> bollingerPoints =
          List<_BollingerData>.filled(limit, null);
