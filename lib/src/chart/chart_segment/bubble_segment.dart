...
class BubbleSegment extends ChartSegment {
  ...
  num _centerX, _centerY, _radius, _size;
  ...
  void calculateSegmentPoints() {
    ...
    _radius = _calculateBubbleRadius(_seriesRenderer);
  ...
  num _calculateBubbleRadius(BubbleSeriesRenderer _seriesRenderer) {
    final BubbleSeries<dynamic, dynamic> bubbleSeries = _series;
  ...
  void onPaint(Canvas canvas) {
    ...
    if (_seriesRenderer._chartState._widgetNeedUpdate &&
        ...
        _seriesRenderer._chartState._oldSeriesRenderers != null &&
