...
class _TooltipPainter extends CustomPainter {
  ...
  void _renderTriangularChartTooltip(Offset position) {
    ...
    pointIndex = _chartState._tooltipPointIndex;
    if (pointIndex == null && _chartState._currentActive == null) {
      num _pointIndex;
      bool isPoint;
  ...
  void _renderTooltip(Canvas canvas) {
    ...
    if (x != null &&
      ...
      if (_chart.onTooltipRender != null && !dataPoint.isTooltipRenderEvent) {
        ...
        dataPoint._tooltipLabelText = stringValue;
        dataPoint._tooltipHeaderText = header;
        tooltipArgs.locationX = x;
        tooltipArgs.locationY = y;
        dataPoint._tooltipLocationX = x;
        dataPoint._tooltipLocationY = y;
        _chart.onTooltipRender(tooltipArgs);
        dataPoint._tooltipLabelText = tooltipArgs.text;
        dataPoint._tooltipHeaderText = tooltipArgs.header;
        dataPoint._tooltipLocationX = tooltipArgs.locationX;
        dataPoint._tooltipLocationY = tooltipArgs.locationY;
      }
      if (tooltipAnimation.status == AnimationStatus.completed) {
        dataPoint?.isTooltipRenderEvent = false;
      }
      if (_chart.onTooltipRender != null) {
        stringValue = dataPoint._tooltipLabelText;
        header = dataPoint._tooltipHeaderText;
        x = dataPoint._tooltipLocationX;
        y = dataPoint._tooltipLocationY;
      }
    }
