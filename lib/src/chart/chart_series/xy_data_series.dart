...
class CartesianChartPoint<D> {
  ...
  /// Stores the data label offset.
  Offset _dataLabelOffset;
  ...
  /// Stores the tooltip x location.
  double _tooltipLocationX;

  /// Stores the tooltip y location.
  double _tooltipLocationY;
}
