...
void _calculateDataLabelPosition(
  ...
  if (dataLabelSettingsRenderer._angle.isNegative) {
    final num angle = dataLabelSettingsRenderer._angle + 360;
  ...
  if (chart.onDataLabelRender != null &&
    ...
    point._dataLabelOffset = dataLabelArgs.offset;
  }
  ...
  if (chart.onDataLabelRender != null) {
    ...
    dataLabelSettingsRenderer._offset = point._dataLabelOffset;
    ...
    if (label.isNotEmpty) {
      ...
      if (seriesRenderer._seriesType == 'hiloopenclose' ||
        ...
        if (seriesRenderer._seriesType.contains('hilo')) {
          ...
          if (seriesRenderer._chartState._requireInvertedAxis) {
            chartLocation3 = _ChartLocation(
                point.lowerQuartilePoint.x + boxPlotPadding,
                markerPoint2.y + 1);
          } else {
            chartLocation3 = _ChartLocation(
        ...
        if (seriesRenderer._seriesType.contains('hilo')) {
          ...
          if (seriesRenderer._chartState._requireInvertedAxis) {
            chartLocation4 = _ChartLocation(
                point.upperQuartilePoint.x - boxPlotPadding,
                markerPoint3.y + 1);
          } else {
            chartLocation4 = _ChartLocation(
                point.region.bottomCenter.dx, markerPoint3.y + boxPlotPadding);
          }
        } else {
          chartLocation4 =
        ...
        if (isBoxSeries) {
          textSize5 = _measureText(point.label5, font);
          if (!seriesRenderer._chartState._requireInvertedAxis) {
            chartLocation5 = _ChartLocation(
...
_ChartLocation _getSecondLabelLocation(
  ...
  if (seriesRenderer._seriesType == 'boxandwhisker') {
    ...
    minus = (point.low < 0 && !inversed) || (!(point.low < 0) && inversed);
  }
    ...
    if (dataLabelSettingsRenderer._color != null || dataLabel.useSeriesColor) {
      ...
      if (seriesRenderer._seriesType == 'waterfall') {
        seriesColor = _getWaterfallSeriesColor(
            seriesRenderer._series, point, seriesColor);
      }
      ...
      if (isBoxSeries) {
        if (point.outliers.isNotEmpty) {
          ...
          for (int outlierIndex = 0;
            ...
            outliersTextSize.add(_measureText(
